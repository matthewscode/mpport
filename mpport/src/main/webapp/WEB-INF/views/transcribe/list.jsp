		...
		<div class="ft-work-editors">
		 <div class="ft-detail-transcription">
			...
			<div class="ft-button-wrapper">
				...
				<div class="ft-pad"></div>
				<div class="ft-word-count-box" ng-class="{'ft-green' : trans}">{{ transcriptionWordCount }} w</div>
			</div>
		</div>
...
<div class="ft-loading" ng-show="loading">
  ...
  <div data-ng-show="data" class="ft-list" ng-class="{'has-editor': showEditor}">
  	...
  	<div data-ng-repeat="ft in data" class="ft-box" ng-click="setEditor('<c:url value="${client.apiLocation}/api/ic/get/transription/translation/" />', ft.checksumId, ft.originUrl, ft); trans = false; transl = false;">
